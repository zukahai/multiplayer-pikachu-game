...
public class BoadGame extends JFrame {
	...
	public Icon getIcon(int index) {
		int width = 52;
		int height = 56;
		Image image = new ImageIcon(getClass().getResource("/images/pieces" + index + ".png")).getImage();
	...
	public Icon getAvata(int index) {
		int width = 50;
		int height = 50;
		Image image = new ImageIcon(getClass().getResource("/avatas/" + index + ".png")).getImage();
		Icon icon = new ImageIcon(image.getScaledInstance(width, height, image.SCALE_SMOOTH));
		return icon;
	}
}
